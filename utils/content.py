...
Введите название (или часть названия) клуба, либо /cancel для отмены.
"""
...
battle_scatter_caption = 'Трактовка: каждая точка - совместный забег, чем ближе точки к левому нижнему углу и красной линией, тем  больше соперничество.'
