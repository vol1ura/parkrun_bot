...
🤖 <b>Parkrunner Bot</b>, версия 0.2.2"""
...
throttled_messages = ["Подождите, я не успеваю 🤯", "Данный запрос нельзя выполнять так часто 🤪",
                      ...
                      "Зачем так часто нажимать одну и ту же кнопку? 🤔"]
...
В дальнейшем вы всегда можете изменить свой выбор, воспользовавшись меню или командами типа 
/setсlub {0} либо
/setclub {1} (по id клуба).
"""
