...
instagram_profiles = [
    ...
    "begovoy.monastyr", "diehardrunning", "russiarunning", "stepan_kiselev_run", "sokslav", "parkrunkuzminki"
]
...
phrases_about_admin = ['Сейчас придёт и разберётся.', 'Не буди лихо!', 'Всех в бан!', 'Модерирует и добавляет.',
                       'Вообще-то я тут главный!', 'Если что, я - за старшего!']
...
🤖 <b>Parkrunner Bot</b>, версия 0.4.23"""
