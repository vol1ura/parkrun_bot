...
parkrun_code_search = "Введите свой номер в системе parkrun (*цифры* с вашего штрих-кода, *без буквы A*)."

parkrun_code_check = 'Не удалось найти участника с parkrun ID={parkrun_code}. ' \
...
'<a href="https://www.parkrun.com.au/results/athleteresultshistory/?athleteNumber={parkrun_code}">на сайте parkrun</a>.'

settings_save_failed = 'Неожиданная ошибка. Не удалось сохранить настройки. Попробуйте ещё раз.'

found_athlete_info = 'Найден участник - {name}. Посмотреть <a href="https://s95.ru/athletes/{athlete_id}">страницу участника на сайте</a>.'

help_to_find_id = 'Зайдите на сайт s95.ru и попробуйте через поиск найти себя. Ваш ID можно будет увидеть, нажав кнопку \[штрихкод] на страничке участника.'
