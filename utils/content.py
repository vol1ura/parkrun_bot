...
start_message = 'Parkrunner Bot подключен. Чтобы вызвать бота, вы должны обратиться к нему, ' \
                ...
                'Также вы можете вызывать справку, набрав команду /help'

about_message = "<b>Parkrunner Bot</b>, версия 0.1.0\n" \
                "Вопросы, предложения и замечания направляйте @vol1ura\n\n" \
                "Справка по использованию: /help\n" \
                "Справка на сайте: <a href=\"https://parkrunbot.herokuapp.com/\">parkrunbot.herokuapp.com</a>"
