...
ask_club = """Список всех зарегистрированных клубов можно посмотреть [на сайте](https://s95.ru/clubs). \
Если вашего нет в списке напишите нам на info@s95.ru и мы добавим его. 

Введите название *из списка* или /cancel для отмены.
"""
