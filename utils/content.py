...
no_parkrun_message = """Вы не установили паркран, для которого хотите получать статистику.
...
success_parkrun_set = """Вы выбрали паркран {}. Настройки успешно сохранены.
В дальнейшем вы всегда можете изменить свой выбор, воспользовавшись меню или командой /settings.
"""

success_club_set = """Настройки успешно сохранены. Вы выбрали клуб [{}](https://www.parkrun.ru/groups/{}/).
В дальнейшем вы всегда можете изменить свой выбор, воспользовавшись меню или командой /settings.
"""
