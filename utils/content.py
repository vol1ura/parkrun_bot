...
'К сожалению, паркран в Москве и Московской области временно отменён (до 2 апреля 2021 года).',
'Узнать в каких городах сейчас проводится parkrun можно тут http://parkrun.me/ruopen',
...
'Суббота. Утро. Парк. С 3 апреля 2021 года!',
...
about_message = "<b>Чат-бот Wake&Run</b>, версия 0.3.3\n" \
